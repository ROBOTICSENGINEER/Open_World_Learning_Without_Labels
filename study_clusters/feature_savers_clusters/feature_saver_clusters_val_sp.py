...
t0 = time.time()
folder = "/scratch/mjafarzadeh/result_val_sp/"
output_folder = f"/scratch/mjafarzadeh/result_val_sp/"
output_name = f"feature_cluster_val_sp.pth"
  ...
  for u in [5, 10,25,50]:
    for test_id in range(1,6):
      ...
      for file in os.listdir(folder):
        if f'track_val_sp_u{u}_{test_id}_new_clusters_' in file:
