...
folder = "/scratch/mjafarzadeh/result_v2_s/"
output_folder = f"/scratch/mjafarzadeh/result_v2_s/"
output_name = f"feature_cluster_v2_s.pth"
    ...
    for u in [5, 10, 25, 50]:
        for test_id in range(1, 6):
            ...
            for file in os.listdir(folder):
                if f"track_v2_s_u{u}_{test_id}_new_clusters_" in file:
