...
t0 = time.time()
_name_feature_extractor_ = "S"
folder = "/scratch/mjafarzadeh/result_val_s/"
output_folder = f"/scratch/mjafarzadeh/result_val_s/"
output_name = f"feature_cluster_val_s.pth"
...
class list_data_class(Dataset):
    def __init__(self, image_list, transform_supervised):
    ...
    for u in [5, 10, 25, 50]:
        for test_id in range(1, 6):
            ...
            for file in os.listdir(folder):
                if f"track_val_s_u{u}_{test_id}_new_clusters_" in file:
            ...
            for cluster in range(1, 1 + N_cluster):
                ...
                data_set = list_data_class(image_list=images_list, transform_supervised=image_transform_supervised)
