...
class csv_data_class(Dataset):
    def __init__(self, path, transform_supervised):
        with open(path) as f:
    ...
    def __getitem__(self, index):
        ...
        # y = int(L)
        # return (x,y)
        return (address, x_supervised)


dataset_test = csv_data_class(path=test_csv_path, transform_supervised=image_transform_supervised)
