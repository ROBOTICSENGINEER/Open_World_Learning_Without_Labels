...
name = "supervised_mocoPlaces_tail33998_ct7_dm045_65"

tests_csv_root = "../data/all_test_166/"

csv_folder = './csv_folder/supervised_mocoPlaces_045_065'
  ...
  def feature_extraction(self, dataset_path, dataset_root):
    ...
    for k, data in enumerate(loader):
      with autocast():
        ...
        image_features = np.hstack((FV_supervised.cpu().data.numpy(), FV_mocoPlaces.cpu().data.numpy()))
