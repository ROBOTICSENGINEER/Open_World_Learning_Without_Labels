...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = moco.builder.MoCo(efficientnet_b3, args.moco_dim, args.moco_k, args.moco_m, args.moco_t, args.mlp)
    ...
    traindir = '/scratch/datasets/ImageNet/ILSVRC_2012/train'
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (args.multiprocessing_distributed
            ...
            }, is_best=False, filename='moco_imagenet_{:04d}.pth.tar'.format(epoch))
...
def save_checkpoint(state, is_best, filename='moco_imagenet.pth.tar'):
