...
csv_name_dict = {
    0: "imagenet_test_v2_73.csv",
    1: "imagenet_test_v2_85.csv",
    2: "imagenet_test_v2_93.csv",
    3: "imagenet_1000_val.csv",
    4: "imagenet_166.csv",
}
...
with torch.no_grad():
    for k in range(5):
        ...
        data_set = csv_data_class(
            path=f"/scratch/mjafarzadeh/" + csv_name,
