...
name = "Label_supervised_mocoPlaces_tail33998_ct7_dm045_65"
...
evm_model_path = '/scratch/EVM_cosine_model_imagenet_b3_joint_supervised_mocoPlaces2_tail33998_ct70_dm45.hdf5'
...
csv_folder = './csv_folder/Label_supervised_mocoPlaces_045_065'
cores = 32
  ...
  def feature_extraction(self, dataset_path, dataset_root):
    ...
    for k, data in enumerate(loader):
      with autocast():
        ...
        image_features = torch.cat((FV_supervised.detach().cpu(), FV_mocoPlaces.detach().cpu()),1).detach().cpu()
