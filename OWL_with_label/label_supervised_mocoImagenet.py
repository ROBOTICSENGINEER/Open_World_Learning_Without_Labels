...
name = "Label_supervised_mocoImagenet_tail33998_ct7_dm045_65"
...
csv_folder = './csv_folder/Label_supervised_mocoImagenet_045_065'
cores = 32
  ...
  def feature_extraction(self, dataset_path, dataset_root):
    ...
    for k, data in enumerate(loader):
      with autocast():
        ...
        image_features = torch.cat((FV_supervised.detach().cpu(), FV_mocoImagenet.detach().cpu()),1).detach().cpu()
